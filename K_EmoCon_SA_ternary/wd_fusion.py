...
if __name__ == '__main__':
    ...
    new_df.to_csv('baselines/fusion_wd/fusion_wd_acc_loss.csv')

        
    np.savetxt(f'baselines/fusion_wd/{emotion}_{model_name_base}_all_pred_train.txt',pred_train)
    np.savetxt(f'baselines/fusion_wd/{emotion}_{model_name_base}_all_label_train.txt', label_train)
