...
if __name__ == '__main__':
    model_name_base = 'baseline_fusion_cossim_text_trans'
    model_name = f'{emotion}_baseline_fusion_cossim_text_trans.chkpt'
    ...
    np.savetxt(f'baselines/fusion_cossim_ds/{emotion}_{model_name_base}_all_pred_train.txt',pred_train)
    np.savetxt(f'baselines/fusion_cossim_ds/{emotion}_{model_name_base}_all_label_train.txt',label_train)
    print('ALL DONE')               
