...
if __name__ == '__main__':
    ...
    X_train, X_val, y_train, y_val = train_test_split(X, y, random_state = 2, test_size = 0.33)
    ...
    for r in range(1):
        ...
        model = Transformer(device=device, d_feature=val_text.text_len, d_model=d_model, d_inner=d_inner,
        ...
        model = model.to(device)
        test_epoch(valid_loader_text, device, model, val_text.__len__())
