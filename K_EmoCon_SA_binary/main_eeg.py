...
if __name__ == '__main__':
    ...
    np.savetxt(f'baselines/eeg/{emotion}_{model_name_base}_all_pred_train.txt',train_pred)
    np.savetxt(f'baselines/eeg/{emotion}_{model_name_base}_all_label_train.txt', train_label)
    print('ALL DONE')               
