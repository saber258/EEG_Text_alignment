...
def train_epoch(train_loader, device, model, optimizer, total_num):
    ...
    return train_loss, train_acc, cnt_per_class, cm, all_pred, all_labels
...
if __name__ == '__main__':
    ...
    for epoch_i in range(epoch):
        print('[ Epoch', epoch_i, ']')
        start = time.time()
        train_loss, train_acc, train_cnt, train_cm, all_pred, all_label  = train_epoch(train_loader_text_eeg, device, model, optimizer, train_text_eeg.__len__())
