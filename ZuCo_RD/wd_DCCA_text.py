...
if __name__ == '__main__':
    model_name_base = 'baseline_onlytext_dcca_wd_trans_test'
    model_name = f'{emotion}_baseline_onlytext_dcca_wd_trans_test.chkpt'
    ...
    new_df.to_csv('baselines/DCCA_ds/dcca_wd_text_acc_loss.csv')
