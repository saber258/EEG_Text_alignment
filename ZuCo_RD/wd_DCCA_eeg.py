...
def cal_loss(pred, label, pred2, device):
    ...
    loss3 = wasserstein_distance(pred.cpu().detach().numpy().flatten(), 
...
if __name__ == '__main__':
    model_name_base = 'baseline_onlyeeg_dcca_wd_trans'
    model_name = f'{emotion}_baseline_onlyeeg_dcca_wd_trans.chkpt'
    ...
    new_df.to_csv('baselines/DCCA_ds/dcca_wd_eeg_acc_loss.csv')
