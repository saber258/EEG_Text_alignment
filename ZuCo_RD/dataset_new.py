...
#     self.model1 = model1
#     self.model2 = model2
#     self.Transformer = Transformer3(device=device, d_feature=20, d_model=d_model, d_inner=d_inner,
#                             n_layers=n_layers, n_head=n_head, d_k=64, d_v=64, dropout=dropout, class_num=class_num)
#     self.classifier = nn.Linear(20, class_num)
...
class BiLSTM(nn.Module):
    ...
    def __init__(self, vocab_size, device, embedding_dim = 32, hidden_dim1 = 128, hidden_dim2 = 64, output_dim = 10, n_layers =2,
...
class MLP2(nn.Module):
  #vocab_size = 48, 32, 838
    def __init__(self, vocab_size, embed_size = 1, hidden_size2 = 256, hidden_size3 = 128, hidden_size4 = 64, 
    output_dim = class_num, dropout = 0.3, max_document_length = 833):
        super().__init__()
        # embedding and convolution layers
        self.embedding = nn.Embedding(vocab_size, embed_size)
        self.relu = nn.ReLU()
