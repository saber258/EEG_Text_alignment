...
from dataset_new import EEGDataset, TextDataset, BalancedBatchSampler, Text_EEGDataset, BiLSTM
from config import *
...
if __name__ == '__main__':
    model_name_base = 'baseline_onlyeeg_bilstm'
    model_name = f'{emotion}_baseline_onlyeeg_bilstm.chkpt'
    ...
    model = BiLSTM(vocab_size = 833, device = device)
